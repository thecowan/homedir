...
globalkeys = awful.util.table.join(
    ...
    awful.key({ "Shift", "Control" }, "j", function ()
        awful.util.spawn("fetchotp -x --account='funkwit@gmail.com'") end),
    awful.key({ "Shift", "Control" }, "k", function ()
        awful.util.spawn("fetchotp -x --account='paul@mailcow.com'") end),

    awful.key({         }, "XF86HomePage", function () awful.screen.focus(1) end),
    awful.key({ "Shift" }, "XF86HomePage", function () awful.client.movetoscreen(c, 1) end),
    awful.key({         }, "XF86Mail", function () awful.screen.focus(2) end),
    awful.key({ "Shift" }, "XF86Mail", function () awful.client.movetoscreen(c, 2) end),
    awful.key({ }, "XF86Favorites", function () awful.util.spawn("gnome-screensaver-command  --lock") end),
